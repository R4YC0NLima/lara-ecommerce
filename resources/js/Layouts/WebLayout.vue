...
import ShopCart from '@/Shared/Cart.vue'
...
<template>
    <div>
        ...
        <nav class="bg-gray-800">
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                <div class="relative flex items-center justify-between h-16">
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">                        
                        ...
                        <!-- Settings Dropdown -->
                            <a @click="openShopCart = !openShopCart">
            ...
            <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <JetResponsiveNavLink :href="route('products.index')" :active="route().current('products.index')">
                            Produtos
        ...
        <ShopCart :openShopCart="openShopCart" :closeShopCart="closeShopCart = !close" />
    </div>
</template>
<!-- <script>
