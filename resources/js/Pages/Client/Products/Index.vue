<template>
<WebLayout title="Produtos" class="bg-white">
  <div>
    <!--
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="relative z-10 flex items-baseline justify-between pt-20 pb-6 border-b border-gray-200">
        <h1 class="text-4xl font-extrabold tracking-tight text-gray-900">Produtos</h1>
                ...
                <div class="bg-white">
                    <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
                        ...
                        <a href="#" v-for="product in products" :key="product.id"  class="group">
                            ...
                            <SideLink :href="route('addCart', {'idProduct' : product.id})" class="bg-gray-300 p-1 rounded-md border-md">Adicionar item</SideLink>
                        </a>
                        <!-- More products... -->
                        </div>
                    </div>
