                                ...
                                <div class="overflow-hidden">
                                    <div class="flex justify-between">
                                        ...
                                        <div class="float-right bg-gray-800 text-white  py-2 px-4 border border-blue-700 rounded">
                                            <Link :href="route('admin.clients.create')">Novo Cliente</Link>
                                        </div>
                                    </div>
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody v-for="(client, index) in clients.data" :key="index">
                                            <tr class="border-b" >
                                                ...
                                                <td class="text-sm text-red-900 font-light px-6 py-4 whitespace-nowrap flex">
                                                    <div class="bg-yellow-800 text-white mr-2 py-2 px-4 border border-blue-700 rounded">
                                                        <Link :href="route('admin.clients.edit', client.id)">Editar</Link>
                                                    </div>
                                                    <div class="bg-red-800 text-white py-2 px-4 border border-blue-700 rounded">
                                                        <Link method="delete" :href="route('admin.clients.destroy', client.id)">Remover</Link>
                                                    </div>
                                                </td>
                                            </tr>
...
export default {
    ...
    methods: {
        search: _.throttle(function(){
            this.$inertia.replace(route('clients.index', {term:this.term}, { preserveState: true }))
        }, 500),
    }
