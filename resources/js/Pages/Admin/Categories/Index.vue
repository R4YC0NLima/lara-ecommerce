                                ...
                                <div class="overflow-hidden">
                                    <div class="flex justify-between">
                                        ...
                                        <div class="float-right bg-gray-800 text-white  py-2 px-4 border border-blue-700 rounded">
                                            <Link :href="route('admin.categories.create')">Nova Categoria</Link>
                                        </div>
                                    </div>
                                    ...
                                    <table class="min-w-full">
                                        ...
                                        <tbody v-for="(category, index) in categories.data" :key="index">
                                            <tr class="border-b" >
                                                ...
                                                <td class="text-sm text-red-900 font-light px-6 py-4 whitespace-nowrap flex">
                                                    ...
                                                    <div class="bg-red-800 text-white py-2 px-4 border border-blue-700 rounded">
                                                        <Link method="delete" :href="route('admin.categories.destroy', category.id)">Remover</Link>
                                                    </div>
                                                </td>
                                            </tr>
...
export default {
    ...
    methods: {
        search: _.throttle(function(){
            this.$inertia.replace(route('admin.categories.index', {term:this.term}, { preserveState: true }))
        }, 500),
    }
